...
bool moving_sphere::hit(const ray& r, double t_min, double t_max, hit_record& rec) const {
    // The time constantly changes, and so does the center. Use the function center() to find
    // the center of the sphere at a certain time. It uses linear interpolation to find
